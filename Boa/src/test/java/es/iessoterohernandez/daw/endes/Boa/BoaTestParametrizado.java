...
class BoaTestParametrizado {
	...
	void withCsvSource(String name, int length, String favoriteFood, boolean exp) {
	}
	...
	public void fitsInCageTest(String name, int length, int cageLength, String favoriteFood, boolean exp) {
